...
# Keep Buildroot host-python isolated from user-provided OpenSSL/Python
# library overrides without changing the outer shell environment.
...
BR2_ROOTFS_OVERLAY = $(ROOT)/build/br-ext/board/qemu/riscv64-virt-optee/rootfs_overlay
BR2_ROOTFS_POST_IMAGE_SCRIPT = $(ROOT)/buildroot/support/scripts/genimage.sh
BR2_ROOTFS_POST_IMAGE_SCRIPT_ARGS = "-c $(ROOT)/build/br-ext/board/qemu/riscv64-virt-optee/genimage_sdcard.cfg"
...
linux: linux-common | $(BINARIES_PATH)
	...
	ln -sf $(LINUX_DTB) $(BINARIES_PATH)/qemu_rv64_virt_domain.dtb
...
update_rootfs: linux
	...
	@install -v -p --mode=644 $(LINUX_DTB) $(BUILDROOT_TARGET_ROOT)/boot/qemu_rv64_virt_domain.dtb
